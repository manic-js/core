  ...
  return (
    <main style={styles.main}>
      ...
      <div style={styles.contentContainer}>
        <p style={styles.message}>A client-side exception occurred.</p>
        <p style={styles.details}>
          Something went wrong while rendering this page. Try reloading — if it keeps happening,
          contact the developers. See the browser console for more information.
        </p>
      </div>
